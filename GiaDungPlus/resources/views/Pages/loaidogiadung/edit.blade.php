...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="/admin/loaidogiadung/edit/{{ $loaidogiadung->MaLoai }}">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Mã Loại: {{ $loaidogiadung->MaLoai }}</h6>
                    </div>
                    @csrf
                    <div class="form-group">
                        <label>Tên loại đồ gia dụng:
                        ...
                        <input type="text" name="TenLoai" id="TenLoai" class="form-control" value="{{ $loaidogiadung->TenLoai }}">
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                            <img style="height:100px; width:100px" src="/images/{{ $loaidogiadung->HinhAnh }}" alt="{{ $loaidogiadung->HinhAnh }}">
                                <label>Hình ảnh:{{ $loaidogiadung->HinhAnh }}
                                    <span title="Tên sản phẩm không bao gồm các giá trị thuộc tính như màu sắc, chất liệu, kích cỡ...">
                                        <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" width="16" height="16" font-size="16" color="primary" style="font-size: 16px; cursor: pointer;">
                                            <path d="M7.4 5v1.2h1.2V5H7.4ZM7.4 8.6V11h1.8V9.8h-.6V7.4H6.8v1.2h.6Z" fill="#0088FF"></path>
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M8 2C4.688 2 2 4.688 2 8s2.688 6 6 6 6-2.688 6-6-2.688-6-6-6ZM3.2 8c0 2.646 2.154 4.8 4.8 4.8s4.8-2.154 4.8-4.8S10.646 3.2 8 3.2A4.806 4.806 0 0 0 3.2 8Z" fill="#0088FF"></path>
                                ...
                                <input hidden type="text" name="HinhAnh" id="HinhAnh" class="form-control" value="{{ $loaidogiadung->HinhAnh }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group" style="margin-top: 67px;">
                                <label>Số lượng loại tồn:
                                    <span title="Tên sản phẩm không bao gồm các giá trị thuộc tính như màu sắc, chất liệu, kích cỡ...">
                                        <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" width="16" height="16" font-size="16" color="primary" style="font-size: 16px; cursor: pointer;">
                                            <path d="M7.4 5v1.2h1.2V5H7.4ZM7.4 8.6V11h1.8V9.8h-.6V7.4H6.8v1.2h.6Z" fill="#0088FF"></path>
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M8 2C4.688 2 2 4.688 2 8s2.688 6 6 6 6-2.688 6-6-2.688-6-6-6ZM3.2 8c0 2.646 2.154 4.8 4.8 4.8s4.8-2.154 4.8-4.8S10.646 3.2 8 3.2A4.806 4.806 0 0 0 3.2 8Z" fill="#0088FF"></path>
                                ...
                                <input type="number" name="SoLuongLoaiTon" id="SoLuongLoaiTon" class="form-control" value="{{ $loaidogiadung->SoLuongLoaiTon }}">
                            </div>
                        </div>
                    </div>
                </form>
