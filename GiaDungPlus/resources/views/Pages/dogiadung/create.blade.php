...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Thêm loại đồ gia dụng</h1>
        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Nhập thông tin loại đồ gia dụng</h6>
            </div>
            <div class="card-body">
                <form method="POST" action="{{route('dogiadung.store') }}">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="Gia" id="Gia" class="form-control" step="0.1">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="TrongLuong" id="TrongLuong" class="form-control" step="0.1">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="color" name="MauSac" id="MauSac" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary text-right">Thêm</button>
                </form>
            </div>
        </div>
    </div>
